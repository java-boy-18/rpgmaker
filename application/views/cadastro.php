    ...
    <div class="form-horizontal" style="margin-right:15%;">
      <form method="post" action="<?php echo base_url('Home/save') ?>">
        ...
        <div class="form-group">
          <div class="col-sm-6">
            <center><button type="submit" style="background-color: #343A40; border: none;padding: 15px 32px;border-radius: 5px;box-shadow: -5px 5px 5px #1d2124;">SALVAR</button></center>
          </div>
        </div>
      </form>
    </div>
